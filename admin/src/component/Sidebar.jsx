...
function Sidebar() {
  ...
  return (
    <div className="w-[18%] min-h-[100vh] bg-black text-white border-r-[1px] py-[20px] fixed left-0 top-[70px]">
      <div className="flex flex-col gap-4 pt-[10px] pl-[20%] text-[15px]">
        <div
