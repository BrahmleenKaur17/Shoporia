...
function Add() {
  ...
  return (
    <div className="w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] overflow-x-hidden relative">
      ...
      <div className="w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute right-0 bottom-[5%]">
        ...
        >
          {/* Title */}
          <div className="w-[400px] h-[50px] text-[25px] md:text-[40px] text-white  mt-[20px]">
            Add Product Page
          </div>
          {/* Upload Images */}
    ...
    bg-slate-600 px-[20px] text-[18px] 
    ...
    hover:border-[#46d1f7] border-[2px] cursor-pointer 
    bg-slate-600 px-[20px] py-[10px] text-[18px] 
    placeholder:text-[#ffffffc2]"
    ...
    placeholder:text-[#ffffffc2]"
          ...
          <div className="w-[80%] flex items-start justify-center flex-col gap-[10px]">
            ...
            <div className="flex items-center justify-start gap-[15px] flex-wrap">
              <div
                className={`px-[20px] py-[7px] rounded-lg 
  bg-slate-600 text-[18px] hover:border-[#46d1f7] border-[2px] cursor-pointer 
  ${sizes.includes("S") ? "bg-green-200 text-black border-[#46d1f7]" : ""}`}
                onClick={() =>
                  setSizes((prev) =>
                    prev.includes("S")
  ...
  ${sizes.includes("XXL") ? "bg-green-400 text-black border-[#46d1f7]" : ""}`}
          ...
          <button
            className="w-[140px] px-[20px] py-[20px] rounded-xl 
  bg-[#65d8f7] flex items-center justify-center gap-[10px] 
